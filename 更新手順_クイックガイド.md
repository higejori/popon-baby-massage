...
| 箇所 | 行番号 | 内容 |
|------|--------|------|
| ヘッダータイトル | 80 | `~姫路 ベビーマッサージ教室~` |
| メインメッセージ | 111 | `笑顔あふれる育児をしよう` |
| 料金・コース | 210〜 | `<section id="courses">`（料金テキストカード） |
| お客様の声 | 312〜 | `<section id="voices">` |
| 講師紹介・メッセージ | 331〜（本文352-357） | `<section id="instructor">` |
| アクセス | 364〜 | `<section id="access">`（Googleマップリンク含む） |
| よくある質問 | 415〜 | `<section id="faq">` |

※行番号は2026-07-04時点。大きな修正のあとは `grep -n "section id" src/index.html` でズレを確認。
